...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/santiago/Documentos/Axiom/public/storage' => 'string',
...
'filesystems.links./home/santiago/Documentos/Axiom/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'hashing.rehash_on_login','view.paths','view.compiled','concurrency.default','passport.guard',
'passport.private_key','passport.public_key','passport.connection','passport.client_uuids','passport.personal_access_client.id',
'passport.personal_access_client.secret','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','livewire.class_namespace','livewire.view_path',
...
'laravel-exceptions-renderer::show','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind',
